...
% Personal color
\definecolor{green_dis_survie}{RGB}{0, 128, 43}
\definecolor{orange_table_mortalite}{RGB}{255, 153, 0}
\definecolor{bleu_hyp_interpolation}{RGB}{24, 172, 179}
\definecolor{rouge_esp_residuel}{RGB}{179, 24, 59}

% Custom enumerate & itemize Package
\usepackage{enumitem}
